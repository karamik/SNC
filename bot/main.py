...
from bot.models.bank import DepositTariff
from bot.middlewares.throttle import ThrottlingMiddleware
from bot.handlers import start, game, profile, admin, shop, tournament, referral, achievements, settings, clan, bank
...
from bot.services.clan import get_clan_rankings
...
async def setup_bot_commands():
    ...
    commands = [
        ...
        BotCommand(command="bank", description="Звёздный банк"),
    ]
...
async def main():
    ...
    await init_events()
    await init_deposit_tariffs(async_session_maker)
